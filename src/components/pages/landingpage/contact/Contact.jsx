            ...
            <div className="contact-form-content">
                ...
                <div className="contact-form-right">
                    ...
                    <ul>
                        ...
                        <li><FaPhoneAlt className='contact-icon'/> Cell: 9876543219</li>
                        <li><FaPhoneAlt className='contact-icon'/> Office: 1234567891</li>
                        <li><FaEnvelope className='contact-icon'/> Email: CabBuddy@gmail.com</li>
                        <li><FaGlobe className='contact-icon'/> Website: CabBuddy .com</li>
                    </ul>
                </div>
            </div>
        </section>
