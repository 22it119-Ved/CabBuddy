    ...
    <section id="featured-cars" ref={ref}>
         <div className="about-content">
            ...
            <Paragraph className="about-description">
                Welcome to our CabBuddy service! We are dedicated to providing you with a safe, reliable, and comfortable ride to your destination. Our team of professional drivers is committed to ensuring that you have the best experience possible.
            </Paragraph>
