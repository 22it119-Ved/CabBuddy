        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-column">
                    <h2 className="footer-logo">CabBuddy</h2>
                ...
                <div className="footer-column">
                    <h3>ABOUT Express</h3>
                    <ul>
                        <li><a onClick={() => showDrawer('About Us')} style={{ cursor: 'pointer' }}>CabBuddy .com</a></li>
                    </ul>
                </div>
                <div className="footer-column">
                    <h3>TOP SERVICES</h3>
            ...
            >
                {drawerTitle === 'Developers Information' ? (
                    ...
                    <div>
                        <h3>About Us</h3>
                        <p>Welcome to our CabBuddy service! We are dedicated to providing you with a safe, reliable, and comfortable ride to your destination. Our team of professional drivers is committed to ensuring that you have the best experience possible.</p>
